COMMENT
        ...
        RANGE d0, p0, scount0, scounttau, alpha
        RANGE d, p, tspike, alpha_scount, scount
        }
        ...
        alpha_scount    : scount scaled by alpha_d - sliding (scount-dependent) modification threshold for depression
        d                : depression factor (multiplicative to prevent
< 0)
        ...
        WATCH (v > -30) 2 :This mechanism watches postsynaptic membrane potential at the location of the mechanism
